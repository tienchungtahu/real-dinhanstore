...
export default function CreatePostPage() {
    ...
    const handleGenerateAI = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setContent(data.content) // Tiptap will render HTML/Markdown
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-6 py-10 pb-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-6">
                    <Card className="bg-muted/30 border-primary/20">
                        ...
                        <CardContent className="space-y-4">
                            <div className="space-y-2">
                                <Label>Tải lên tài liệu (docx, xlsx)</Label>
                                    ...
                                    <label htmlFor="file-upload" className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer hover:bg-muted/50">
                                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                            ...
                                            <p className="text-sm text-muted-foreground">
                                                {uploadedFile ? uploadedFile.name : "Kéo thả hoặc click để upload"}
                                            </p>
                                        </div>
                                        <input id="file-upload" type="file" className="hidden" accept=".docx,.xlsx,.xls" onChange={handleFileUpload} />
                                    </label>
                                </div>
                                {parsedContext && (
                                    <p className="text-xs text-green-600 font-medium text-center">Đã trích xuất nội dung từ file</p>
                                )}
                            </div>
